...
log "    python3 scripts/build_pde_sbatch.py sweep --netid <netid> --repo-dir /local/scratch2/<netid>/MAS-Activation-Cascades --steering-vector steering_vectors/harmfulness_llama3_8b.pt --clean-api-base http://clean-vllm-node:8000/v1 > pde-sweep.sbatch"
